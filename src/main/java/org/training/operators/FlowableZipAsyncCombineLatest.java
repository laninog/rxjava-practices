...
public class FlowableZipAsyncCombineLatest {

    private static final Logger log = LoggerFactory.getLogger(FlowableZipAsyncCombineLatest.class);
    ...
    public static void main(String[] args) {
        ...
        Flowable<String> zip = Flowable.combineLatest(intervalA, intervalB,
